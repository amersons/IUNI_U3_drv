...
#Gionee <zhuangxiaojian> <2013-01-05> modify for GNCameraFeature begin
ifeq ($(GN_CAMERA_FEATURE_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_CAMERA_FEATURE_SUPPORT
endif

ifeq ($(GN_SCALADO_FEATURE_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_SCALADO_FEATURE_SUPPORT
endif

ifeq ($(GN_ARCSOFT_FEATURE_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_FEATURE_SUPPORT
endif

ifeq ($(GN_CRUNCHFISH_FEATURE_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_CRUNCHFISH_FEATURE_SUPPORT
endif

ifeq ($(GN_CAMERA_FEATURE_FACE_BEAUTY_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_FACE_BEAUTY_SUPPORT
endif

ifeq ($(GN_CAMERA_FEATURE_AGEGENDER_DETECTION_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_AGEGENDER_DETECTION_SUPPORT
endif

ifeq ($(GN_ARCSOFT_LIVE_EFFECT_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_LIVE_EFFECT_SUPPORT
endif

ifeq ($(GN_ARCSOFT_NIGHT_SHOT_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_NIGHT_SHOT_SUPPORT
endif

ifeq ($(GN_ARCSOFT_PICZOOM_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_PICZOOM_SUPPORT
endif

ifeq ($(GN_ARCSOFT_SCENE_DETECTION_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_ARCSOFT_SCENE_DETECTION_SUPPORT
endif

ifeq ($(GN_CAMERA_FEATURE_PICTURE_FRAME_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_CAMERA_FEATURE_PICTURE_FRAME_SUPPORT
endif

ifeq ($(GN_CAMERA_FEATURE_GESTURE_SHOT_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_CAMERA_FEATURE_GESTURE_SHOT_SUPPORT
endif
...
ifeq ($(GN_SCALADO_MIRROR_SUPPORT),yes)
LOCAL_CFLAGS += -DCONFIG_GN_SCALADO_MIRROR_SUPPORT
endif
#Gionee <zhuangxiaojian> <2013-01-05> modify for GNCameraFeature end
###########################################################
