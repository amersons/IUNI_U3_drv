...
PRODUCT_PACKAGES += \
    ...
    sensorservice \
    uiautomator
#Gionee wudp 2014-03-17 add for user version save poweroff chg log begin
ifeq ($(GN_Q_BSP_SAVE_POWEROFFCHG_LOG_SUPPORT),y)
PRODUCT_PACKAGES += savelog
endif
#Gionee wudp 2014-03-17 add for user version save poweroff chg log end
