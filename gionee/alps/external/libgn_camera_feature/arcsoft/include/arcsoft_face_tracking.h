...
typedef MLong				AFT_ORIENTPRI;
typedef MLong				AFT_ORIENTCODE;
...
typedef struct{
	...
	MLong           lfaceOrient;            // the face angle 1:0angle 2:90angle, 3:270 angle
...
typedef struct
{
	...
	const MChar Version[20];		// version in string form
...
MRESULT AFT_TuneRectangleStability(
	AFT_ENGINE			hEngine,	//[in] Face Tracking engine
	MLong					nLevel);	//[in] parameter to tune face rectangles stability.
