...
// Gionee <wutangzhi> <2013-10-23> modify for CR00932970 begin
#ifdef ORIGINAL_VERSION
#else
	bool isVideoPaused() { return mVideoPaused; }
	int64_t getResumedVideoTimestampUs(){ return mResumeVideoTimeStampUs;} 
	void resumeVideo(int64_t videoTimeStampUs); 

	int64_t mResumeVideoTimeStampUs; 
	bool mVideoPaused;
#endif
