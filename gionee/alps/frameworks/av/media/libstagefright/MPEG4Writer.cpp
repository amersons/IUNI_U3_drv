...
// Gionee <wutangzhi> <2014-01-21> modify for CR01030324 begin
#ifdef ORIGINAL_VERSION
#else
      mResumeVideoTimeStampUs(-1),
      mVideoPaused(false),
#endif
// Gionee <wutangzhi> <2014-01-21> modify for CR01030324 end
...
#endif
// Gionee <wutangzhi> <2013-10-23> modify for CR00932970 end
...
void MPEG4Writer::release() {
    ...
    mInitCheck = NO_INIT;
    mStarted = false;
//Gionee <zhuangxiaojian> <2014-08-16> modify for CR01345304 begin
#ifdef ORIGINAL_VERSION
#else
	mPaused = false;
#endif
//Gionee <zhuangxiaojian> <2014-08-16> modify for CR01345304 end
}
