...
public class Camera {
    ...
    private static final int CAMERA_MSG_GESTURE          = 0x4000;
	private static final int CAMERA_MSG_NOTIFY_CONTINUOUS_SHOT = 0x8000;
	private static final int CAMERA_MSG_SCENE_DETECTION = 0x10000;
	private static final int CAMERA_MSG_GESTURE_DETECTION = 0x20000;
	private static final int CAMERA_MSG_AGEGENDER_DETECTION = 0x80000;
	...
	private GNFaceDetectionListener mGNFaceListener;
    //Gionee <zhuangxiaojian> <2013-08-20> modify for CR00867956 end
	// Gionee <wutangzh> <2013-09-05> modify for CR00889483 begin
	private SceneDectetionCallback mScenceDetectionCallback;
	private AgeGenderDetectionCallback mAgeGenderDetectionCallback;
	// Gionee <wutangzh> <2013-09-05> modify for CR00889483 end
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            //Gionee <zhuangxiaojian> <2013-08-20> modify for CR00867956 begin
            case CAMERA_MSG_GESTURE:
                if (mGestureCallback != null) {
                    mGestureCallback.onGestureDetection();
                }
                return;
				
            case CAMERA_MSG_NOTIFY_CONTINUOUS_SHOT:
            	if (mCSDoneCallback != null) {
            		mCSDoneCallback.onConinuousShotDone(msg.arg2);
            	}
            	break;
			case CAMERA_MSG_GESTURE_DETECTION:
				if (mGestureEventCallback != null && mGestureEvent != null) {
					int gestureData[] = new int[6];
					for(int i =0; i < 6; i++ ) {
					   gestureData[i] = byteToInt( (byte[])msg.obj, i*4);
					}

					mGestureEvent.setGestureValue(gestureData[0],
												  gestureData[1],
												  gestureData[2],
												  gestureData[3],
												  gestureData[4],
					...
					mGestureEventCallback.onGestureEvent(mGestureEvent);
				}
				break;
			case CAMERA_MSG_AGEGENDER_DETECTION:
				if (mGNFaceListener != null) {
					mGNFaceListener.onGNFaceDetection((Face[])msg.obj, mCamera);
				}
				break;
			//Gionee <zhuangxiaojian> <2013-08-20> modify for CR00867956 end	
			// Gionee <wutangzh> <2013-09-05> modify for CR00889483 begin
			case CAMERA_MSG_SCENE_DETECTION:
				if (mScenceDetectionCallback != null) {
					mScenceDetectionCallback.onSceneDectetion(msg.arg1);
				}
				break;
            // Gionee <wutangzh> <2013-09-05> modify for CR00889483 end
     ...
     *
     */
    public interface GNFaceDetectionListener
    {
        /**
         * Notify the listener of the detected faces in the preview frame.
         *
         ...
         * @param camera  The {@link Camera} service object
         */
        void onGNFaceDetection(Face[] faces, Camera camera);
    }
     ...
     * @param listener the listener to notify
     */
    public final void setGNFaceDetectionListener(GNFaceDetectionListener listener)
    {
        mGNFaceListener = listener;
    }
     ...
     * @hide
     *
     * slowdown continuous shot
     */
    public native void slowdownContinuousShot();
     ...
     * 
     */
    public interface AgeGenderDetectionCallback {
    	public void onAgeGenderDetection(int[][] ageGenderData, int faceNum);
    }
    /**
     * @hide
     * @param ContinuousShotDone
     */
    public void setAgeGenderDetectionCallback(AgeGenderDetectionCallback callback) {
    	mAgeGenderDetectionCallback = callback;
    }
     ...
     * 
     */
    public interface SceneDectetionCallback {
    	public void onSceneDectetion(int sceneType);
    }
    /**
     * @hide
     * @param SceneDectetionCallback
     */
    public void setSceneDectetionCallback(SceneDectetionCallback callback) {
    	mScenceDetectionCallback = callback;
    }
	// Gionee <wutangzh> <2013-09-05> modify for CR00889483 end
    ...
    public static class Face {
	 ...
	 //Gionee <zhuangxiaojian> <2014-10-31> modify for CR01404903 begin
        /**
         * {@hide}
         */
		public int age = 0;
	  ...
	  */
	    public int gender = -1;
	//Gionee <zhuangxiaojian> <2014-10-31> modify for CR01404903 end
    }
	...
	* @hide
       * 
       */
	public void setGestureEventCallback(GestureEventCallback callback) {
	...
	* @hide
	...
	public class GestureEvent {
		private	static final int GESTURE_EVENT_TYPE_BASE 				= 0;
		/** The event type of open hand presence */
		public  static final int GESTURE_EVENT_TYPE_OPEN_HAND_PRESENCE 	= GESTURE_EVENT_TYPE_BASE + 1;
		/** The event type of face presence */
		public  static final int GESTURE_EVENT_TYPE_FACE_PRESENCE 		= GESTURE_EVENT_TYPE_BASE + 2;
		/** The event type of fist presence */
		public  static final int GESTURE_EVENT_TYPE_FIST_PRESENCE		= GESTURE_EVENT_TYPE_BASE + 3;

		/** The event type of unknown */
		public  static final int GESTURE_EVENT_TYPE_UNKNOWN 			= -1;

		private static final int ACTION_BASE 	= 0;
		/** The action of start */
		public  static final int ACTION_START 	= ACTION_BASE + 1;
		/** The action of move */
		public  static final int ACTION_MOVE 	= ACTION_BASE + 2;
		/** The action of end */
		public  static final int ACTION_END		= ACTION_BASE + 3;
		/** The action of unknown */
		...
		* @hide
	       ...
	       */
		public GestureEvent() {
			mType 	= GESTURE_EVENT_TYPE_UNKNOWN;
			mAction = ACTION_UNKNOWN;
			mObjectId = 0;
			mX 		= 0;
			mY		= 0;
			mZ		= 0;
		...
		* @hide
	       * 
	       */
		public void setGestureValue(int type, int action, int objectId, int x, int y, int z) {
			mType 	= type;
			mAction = action;
			mObjectId = objectId;
			mX 		= x;
	...
	* @hide
    ...
    public class Parameters {
        ...
        //Gionee <jiangbo><2013-9-29> modify for CR00825234 begin
        public  static final String KEY_SOUND_STATE = "camera-shutter-sound";
        public  static final String KEY_SOUND_ON = "on";
        public  static final String KEY_SOUND_OFF = "off";
        //Gionee <jiangbo><2013-9-29> modify for CR00825234 end
		...
		private static final String PICTURE_FRAME_NORMAL = "normal";

		private static final String KEY_GESTURE_SUPPORTED = "gesture-supported";
		private static final String KEY_GESTURE_MODE = "gesture";
		public  static final String GESTURE_MODE_ON = "on";
		public  static final String GESTURE_MODE_OFF = "off";		

		public static final String KEY_FACE_BEAUTY_LEVEL = "face-beauty-level";	
		public static final String KEY_SLENDER_FACE_LEVEL = "slender-face-level";
		public static final String KEY_SKIN_SOFTEN_LEVEL = "skin-soften-level";
		public static final String KEY_EYE_ENLARGMENT_LEVEL = "eye-enlargment-level";
        public static final String KEY_FACE_BEAUTY_MODE = "face-beauty-mode";
        public static final String KEY_SUPPOTED_FACE_BEAUTY_MODE = "face-beauty-mode-supported";
        public static final String FACE_BEAUTY_ON = "on";
        public static final String FACE_BEAUTY_OFF = "off";

		public static final String KEY_FACE_BEAUTY_SUB_MODE	= "face-beauty-sub-mode";
		public static final String KEY_FACE_BEAUTY_AGEGENDER_LEVEL = "face-beauty-agegender-level";
		public static final String FACE_BEAUTY_AGEGENDER_MODE = "face-beauty-agegender-mode";
		public static final String FACE_BEAUTY_DEFAULT_MODE = "face-beauty-default-mode";

		public static final String KEY_AGEGENDER_DETECTION_MODE = "agegender-detection-mode";
		public static final String KEY_SUPPOTED_AGEGENDER_DETECTION_MODE = "agegender-detection-mode-supported";
		public static final String AGEGENDER_DETECTION_ON  = "on";
		public static final String AGEGENDER_DETECTION_OFF = "off";

		public static final String KEY_MIRROR_MODE = "mirror-mode";
		public static final String KEY_SUPPOTED_MIRROR_MODE = "mirror-mode-supported";
		public static final String MIRROR_MODE_ON = "on";
		public static final String MIRROR_MODE_OFF = "off";		

		public static final String KEY_GESTURE_EVENT_SUPPORTED = "gesture-event-supported";
		public static final String KEY_GESTURE_EVENT_TYPE = "gesture-event-type";
		public static final String GESTURE_EVENT_NONE = "none";
		public static final String GESTURE_EVENT_OPEN_HAND_PRESENCE = "open-hand-presence";
		public static final String GESTURE_EVENT_FIST_PRESENCE = "fist-presence";
		public static final String GESTURE_EVENT_FACE_PRESENCE = "face-presence";

		public static final String KEY_SCENE_DETECTION_MODE = "scene-detection-mode";
		public static final String KEY_SUPPOTED_SCENE_DETECTION_MODE = "scene-detection-mode-supported";
		public static final String SCENE_DETECTION_ON = "on";
		public static final String SCENE_DETECTION_OFF = "off";

		public static final int SCENE_DETECTION_TYPE_AUTO 				= 1;
		public static final int SCENE_DETECTION_TYPE_PORTRAIT 			= 2;
		public static final int SCENE_DETECTION_TYPE_CLOSEUP 			= 3;
		public static final int SCENE_DETECTION_TYPE_NIGHT 				= 4;
		public static final int SCENE_DETECTION_TYPE_PORTRAIT_NIGHT		= 5;
		public static final int SCENE_DETECTION_TYPE_BACKLIT			= 6;
		public static final int SCENE_DETECTION_TYPE_PORTRAIT_BACKLIT	= 7;
        //Gionee <zhuangxiaojian> <2013-08-20> modify for CR00867956 end

		//Gionee <wutangzhi> <2013-09-23> modify for CR00882216 begin
		private static final String KEY_CAPTURE_MODE = "cap-mode";
		private static final String KEY_SUPPORTED_CAPTURE_MODES = "cap-mode-supported";
         ...
         * @hide
         */
        public static final String CAPTURE_MODE_NIGHT_SHOT = "nightshot";

		/**
         * @hide
         */
        public static final String CAPTURE_MODE_PICZOOM = "piczoom";

		/**
         * @hide
         */
        public static final String KEY_BURST_SHOT_NUM = "burst-num";
		//Gionee <wutangzhi> <2013-09-23> modify for CR00882216 end

		//Gionee <wutangzhi> <2013-09-23> modify for CR00943617 begin
		...
		public static final String LIVE_EFFECT_FLEETINGTIME = "fleetingtime";
		public static final String LIVE_EFFECT_CRAYON = "crayon";
		public static final String LIVE_EFFECT_SNOWFLAKES = "snowflakes";
		public static final String LIVE_EFFECT_LIGHTBEAM = "lightbeam";
		public static final String LIVE_EFFECT_REFLECTION = "reflection";
		public static final String LIVE_EFFECT_SUNSET = "sunset";
		public static final String LIVE_EFFECT_REVERSAL = "reversal";
		public static final String LIVE_EFFECT_WARMLOMO = "warmlomo";
		public static final String LIVE_EFFECT_COLDLOMO = "coldlomo";
		public static final String LIVE_EFFECT_SOFTPINK = "softpink";
		public static final String LIVE_EFFECT_JAPANBACKLIGHT = "japan-backlight";
		public static final String LIVE_EFFECT_COSMETOLOGY_BACKLIGHT = "cosmetology-backlight";
		//Gionee <wutangzhi> <2013-09-23> modify for CR00943617 end
        ...
        **/
        ...
        public static final String SCENE_MODE_GESTURE = "gesture";
		public static final String SCENE_MODE_FOOD = "food";
        ...
        **/
		...
		/**
		  * @hide
		  */
        public boolean isPictureFrameSupported() {
        	String str = get(KEY_PICTURE_FRAME_SUPPORTED);
            return TRUE.equals(str);
        }
		...
		/**
		  * @hide
		  */
		public void setPictureFrame(String value) {
			set(KEY_PICTURE_FRAME, value);
		}
	    ...
	    public boolean isGestureSupported() {
	    	String str = get(KEY_GESTURE_SUPPORTED);
	        return TRUE.equals(str);
	    }
		...
		* @hide
		*/
		public void setFaceBeautyLevel(int value) {
			set(KEY_FACE_BEAUTY_LEVEL, value);
		}		

		/**
		* @hide
		*/
		public void setSlenderFaceLevel(int value) {
			set(KEY_SLENDER_FACE_LEVEL, value);
		}
		
		/**
		* @hide
		*/
		public void setSkinSoftenLevel(int value) {
			set(KEY_SKIN_SOFTEN_LEVEL, value);
		}
		
		/**
		* @hide
		*/
		public void setEyeEnlargmentLevel(int value) {
			set(KEY_EYE_ENLARGMENT_LEVEL, value);
		}
		
		/**
		* @hide
		*/
		public void setFaceBeautyMode(String value) {
			set(KEY_FACE_BEAUTY_MODE, value);
		}

		/**
	      * @hide
	      */
		public String getFaceBeautyMode() {
			return get(KEY_FACE_BEAUTY_MODE);
		}
		...
		public boolean isFaceBeautySupported() {
            String str = get(KEY_SUPPOTED_FACE_BEAUTY_MODE);
            return TRUE.equals(str);
        }		
		...
		* @hide
		*/
		public void setMirrorMode(String value) {
			set(KEY_MIRROR_MODE, value);
		}
		...
		public boolean isMirrorSupported() {
            String str = get(KEY_SUPPOTED_MIRROR_MODE);
            return TRUE.equals(str);
        }		
        ...
        /**
	      * @hide
	      */
		public void setGestureEventType(String value) {
			set(KEY_GESTURE_EVENT_TYPE, value);
		}

		/**
	      * @hide
	      */
		public String getGestureEventType() {
			return get(KEY_GESTURE_EVENT_TYPE);
		}
		
		/**
	      * @hide
	      */
	    public boolean isGestureEventSupported() {
	    	String str = get(KEY_GESTURE_EVENT_SUPPORTED);
	        return TRUE.equals(str);
	    }
		...
		/**
	      * @hide
	      */
		public void setSceneDetectionMode(String value) {
			set(KEY_SCENE_DETECTION_MODE, value);
		}

		/**
	      * @hide
	      */
		public String getSceneDetectionMode() {
			return get(KEY_SCENE_DETECTION_MODE);
		}
	    ...
	    public boolean isSceneDetectionSupported() {
	    	String str = get(KEY_SUPPOTED_SCENE_DETECTION_MODE);
	        return TRUE.equals(str);
	    }
        //Gionee <zhuangxiaojian> <2013-08-20> modify for CR00867956 end
	    ...
	    public List<String> getSupportedCaptureMode() {
	        String str = get(KEY_SUPPORTED_CAPTURE_MODES);
	        return split(str);
	    }

		/**
		 ** @hide
		 ** value: if value is less than 0, burst number is infinite.
		 **/
        ...
        /**
          * @hide
          */
        public void setSoundState(String value) {
        	set(KEY_SOUND_STATE, value);
        }
        ...
        */
		 ...
		 * @hide
		*/
		public void setLiveEffect(String value) {
            set(KEY_LIVE_EFFECT, value);
        }
		...
		*/
		public String getLiveEffect() {
            return get(KEY_LIVE_EFFECT);
        }

		/**
		 * @hide
		*/
		public List<String> getSupportedLiveEffects() {
            String str = get(KEY_LIVE_EFFECT+ SUPPORTED_VALUES_SUFFIX);
            return split(str);
        }
		//Gionee <wutangzhi> <2013-09-23> modify for CR00943617 end
    };
