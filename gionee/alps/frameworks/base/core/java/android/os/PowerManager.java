...
public final class PowerManager {
   ...
   /**
    ...
    //Gionee wanglei, 2013-10-23, add for Torch led, start
    ...
    public boolean isTorchOpened() {
	 int value = 0;
        try {
            File readFile = new File("/sys/class/leds/led:flash_torch/brightness");
            FileReader inCmd = new FileReader(readFile);  
            value = inCmd.read();
	     Log.e(TAG, "wanglei: getTorchBrightness = " + value);     
        } catch (IOException e) {
        }
		
	  return (48 == value)?false:true;
    }
    //Gionee wanglei, 2013-10-23, add for Torch led, end
