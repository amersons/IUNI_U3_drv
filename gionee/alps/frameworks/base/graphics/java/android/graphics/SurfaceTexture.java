...
public class SurfaceTexture {
    ...
    //Gionee <liujun> <2014-02-19> modify for CR00946277 begin
    /**
     * Construct a new SurfaceTexture to stream images to a given OpenGL texture.
     *
     * @param texName the OpenGL texture object name (e.g. generated via glGenTextures)
    ...
    //Gionee <liujun> <2014-02-19> modify for CR00946277 end
    ...
    public SurfaceTexture(int texName, Looper looper, boolean allowSynchronousMode) {
        ...
        nativeInit(texName, allowSynchronousMode, new WeakReference<SurfaceTexture>(this));
    }
    //Gionee <liujun> <2014-02-19> modify for CR00946277 end
