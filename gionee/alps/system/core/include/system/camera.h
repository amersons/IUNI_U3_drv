...
enum {
    ...
    #else
    CAMERA_MSG_GESTURE = 0x4000,
    CAMERA_MSG_NOTIFY_CONTINUOUS_SHOT = 0x8000,
    CAMERA_MSG_SCENE_DETECTION = 0x10000,
    CAMERA_MSG_GESTURE_DETECTION = 0x20000,
    CAMERA_MSG_VIDEO_FLIP = 0x40000,
    CAMERA_MSG_AGEGENDER_DETECTION = 0x80000,
    CAMERA_MSG_ALL_MSGS = 0xFFFFFFFF,
    #endif
...
enum {
	...
	#else
    CAMERA_CMD_SLOW_CONTINUOUS_SHOT = 14,
    CAMERA_CMD_SET_CSHOT_SPEED = 15,
    CAMERA_CMD_CANCEL_CSHOT = 16,
    CAMERA_CMD_LONGSHOT_ON = 17,
    CAMERA_CMD_LONGSHOT_OFF = 18,
	#endif
