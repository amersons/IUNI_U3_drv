...
static const struct option OPTIONS[] = {
  ...
  { "wipe_internal_data", no_argument, NULL, 'i' },
...
//Gionee wangzhen 2014-06-12 add for ota upgrade begin
static const char *SDCARD_ROOT = "/sdcard";
//static const char *SDCARD_ROOT = "/data/media/0";
//Gionee wangzhen 2014-06-12 add for ota upgrade begin
...
static int erase_data_without_internal(void)
{

    ui->Print("Formatting Data ......\n");

    LOGI("IUNI wolfu erase_data_without_internal.\n");
...
wipe_data(int confirm, Device* device) {
    ...
    ui->Print("\n-- Wiping data...\n");
    device->WipeData();
        if(!wipe_internal_data)
        	erase_data_without_internal();
        else
    erase_volume("/data");
    erase_volume("/cache");
    ...
    for (;;) {
        ...
        switch (chosen_item) {
            ...
            case Device::APPLY_EXT:
                ...
                status = update_directory(SDCARD_ROOT, NULL, &wipe_cache, device);
...
main(int argc, char **argv) {
    ...
    //modify by aurora hujianwei 20141112
    printf("<aurora>Start system Check.\n");
    int ret = system("sh /system/etc/systemfile_md5_update.sh");
    printf("<aurora>check ret = %d\n", ret);
    //modify by aurora hujianwei 20141112
    ...
    while ((arg = getopt_long(argc, argv, "", OPTIONS, NULL)) != -1) {
        ...
        case 'i': wipe_data = wipe_cache = wipe_internal_data = 1; break;
