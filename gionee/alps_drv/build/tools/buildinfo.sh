...
echo "ro.gn.extvernumber=IUNI-Alpha-2.0"
...
factory=`cat ~/U3/trunk/gionee/alps_IUNI/gionee/alps_drv/build/tools/factoryver`
let factory+=1
echo $factory>~/U3/trunk/gionee/alps_IUNI/gionee/alps_drv/build/tools/factoryver

echo "ro.gn.iuniznvernumber=IUNI-U3-AlphaV2.0-$version"
echo "ro.gn.gnznvernumber=NBL8910A01_A_T"$factory
echo IUNI-U3-AlphaV2.0-$version>ver
