...
//add liujiang hall-key start
        case AKEYCODE_HALL_O:
        case AKEYCODE_HALL_C:
//add liujiang hall-key end
//Gionee luliya add begin 
        case AKEYCODE_GESTURE_U_UP:
        case AKEYCODE_GESTURE_U_DOWN:
        case AKEYCODE_GESTURE_U_LEFT:
        case AKEYCODE_GESTURE_U_RIGHT:
        case AKEYCODE_DOUBLE_WAKE:
    	case AKEYCODE_CROSS_RIGHT:
    	case AKEYCODE_CROSS_LEFT:
		case AKEYCODE_CHARACTER_O:
    	ALOGE("luliya3: AKEYCODE_GESTURE_U_UP ..... \n");
