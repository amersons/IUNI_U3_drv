...
//		bdata->bus_reg_name = name;
    ...
    of_property_read_string(np, "synaptics,fw-image-name1",
         &bdata->fw_image_name1);
	of_property_read_string(np, "synaptics,fw-image-name2",
         &bdata->fw_image_name2);
	of_property_read_string(np, "synaptics,fw-image-name3",
         &bdata->fw_image_name3);
    of_property_read_string(np, "synaptics,fw-image-name4",
         &bdata->fw_image_name4);
	of_property_read_string(np, "synaptics,fw-image-name5",
         &bdata->fw_image_name5);
	of_property_read_string(np, "synaptics,fw-image-name6",
         &bdata->fw_image_name6);
	of_property_read_string(np, "synaptics,fw-image-name7",
         &bdata->fw_image_name7);
	of_property_read_string(np, "synaptics,fw-image-name8",
         &bdata->fw_image_name8);

    printk("tpd: rmi4_pdata->fw_image_name1 = %s,rmi4_pdata->fw_image_name2 = %s\n", bdata ->fw_image_name1,bdata ->fw_image_name2);
    printk("tpd: rmi4_pdata->fw_image_name3 = %s,rmi4_pdata->fw_image_name4 = %s\n", bdata ->fw_image_name3,bdata ->fw_image_name4);
    printk("tpd: rmi4_pdata->fw_image_name5 = %s,rmi4_pdata->fw_image_name6 = %s\n", bdata ->fw_image_name5,bdata ->fw_image_name6);
	printk("tpd: rmi4_pdata->fw_image_name7 = %s,rmi4_pdata->fw_image_name8 = %s\n", bdata ->fw_image_name7,bdata ->fw_image_name8);
