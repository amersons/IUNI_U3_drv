...
//********************************************************************************
//#include "msm_actuator.h"  //gionee add by chenqiang 20140505
#include <linux/module.h>
#include "msm_sd.h"
extern void RegWriteA(uint32_t add , uint16_t data);
extern void RamWriteA(uint32_t add , uint16_t data);
extern void RamWrite32A(uint32_t add , uint32_t data);
extern void RegReadA(uint32_t add , unsigned char *data);
extern void RamReadA(uint32_t add , uint16_t *data);
extern void RamRead32A(uint32_t add , unsigned long *data);
