...
#Gionee chenqiang  20140506 modify for camera .so start
MM_CAMERA += libactuator_lc898122_camcorder
MM_CAMERA += libactuator_lc898122_camera
#Gionee chenqinag  20140506 modify for camera .so end
...
#Gionee liushengbin 20131011 modify for camera .so start
MM_CAMERA += libchromatix_gn_sunny_ov4688_ar
MM_CAMERA += libchromatix_gn_sunny_ov4688_common
MM_CAMERA += libchromatix_gn_sunny_ov4688_preview
MM_CAMERA += libchromatix_gn_sunny_ov4688_default_video
MM_CAMERA += libchromatix_gn_sunny_ov4688_hfr
MM_CAMERA += libchromatix_gn_sunny_ov4688_zsl
MM_CAMERA += libchromatix_gn_sunny_ov4688_liveshot
#Gionee liushengbin 20131011 modify for camera .so end
...
#Gionee liushengbin 20131011 modify for camera .so start 
MM_CAMERA += libmmcamera_gn_sunny_ov4688
#Gionee liushengbin 20131011 modify for camera .so end 
...
#Gionee liushengbin 20131011 modify for camera .so start 
MM_CAMERA += libmmcamera_liteon_imx135_eeprom
#Gionee liushengbin 20131011 modify for camera .so end 
...
#Gionee liujiang 2013-05-27 add for akm8963 start
SENSORS += libAKM8963
SENSORS += libsensor_test2
#Gionee liujiang 2013-05-27 add for akm8963 end
...
#Gionee liuxw 2014-05-13 add for qc nv item begin
#QC NV ITEM
QC_NV_ITEM := qcnvitems
QC_NV_ITEM += qcrilhook
QC_NV_ITEM += qcnvitems.xml
QC_NV_ITEM += qcrilhook.xml
QC_NV_ITEM += qcrilmsgtunnel
#Gionee liuxw 2014-05-13 add for qc nv item end
