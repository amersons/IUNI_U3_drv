...
//Gionee liujiang 2014-06-12 add for debug start
#define DBG_SMGR_POWERRAIL					 37
#define DBG_SMGR_SENSOR_ENABLE				 38
//Gionee liujiang 2014-06-12 add for debug end
