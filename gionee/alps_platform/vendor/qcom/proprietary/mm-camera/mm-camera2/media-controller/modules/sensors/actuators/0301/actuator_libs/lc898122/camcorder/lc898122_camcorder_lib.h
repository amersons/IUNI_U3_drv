    ...
    /* actuator_params_t */
    {
      ...
      /* msm_actuator_reg_tbl_t */
      {
        ...
        /* msm_actuator_reg_params_t */
        {
          ...
          {MSM_ACTUATOR_WRITE_DAC, 0x00000400, 0x0304,  0,            0},
        },
      },
      /* init_setting_size */
      0,
      /* init_settings */
      {
        {0xEC, 0xA3}, /* Ringing setting On */
        {0xA1, 0x05}, /* DLC and MCLK[1:0] setting */
        {0xF2, 0x08}, /* T_SRC[4:0] setting */
        {0xDC, 0x51}, /* Ringing setting OFF */
      },
    }, /* actuator_params_t */
          ...
          /* damping[MOVE_NEAR] */
          {
            /* scenario 1 */
            {
              /* region 1 */
              {
                .damping_step = 0x1FF,
                .damping_delay = 7000,
                .hw_params = 0x0000000C,  //gionee chenqiang note : the bit-11 be better to fixd to 1 
                                          //.hw_params = 0x00000400
                                          //please  tanrf take care of this bit
              },
              /* region 2 */
              {
                .damping_step = 0x1FF,
