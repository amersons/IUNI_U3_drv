...
###Gionee lingfen 2012-12-4  add for gn_common.mk start
include $(TOPDIR)gn_project/gn_common.mk
###Gionee lingfen 2012-12-4  add for gn_common.mk end
...
###Gionee lingfen 2012-12-4  add for merge 8x25 start
PRODUCT_BRAND := qcom
#PRODUCT_LOCALES := en_US es_US de_DE zh_CN
PRODUCT_LOCALES := zh_CN en_US
PRODUCT_LOCALES += hdpi mdpi
###Gionee lingfen 2012-12-4  add for merge 8x25 end
