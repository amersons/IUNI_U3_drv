...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
    ...
    if (format->findInt32(kKeyBitWidth, &bitWidth) && bitWidth == 24) {
		audioFormat = AUDIO_FORMAT_PCM_24_BIT;
	}else if(format->findInt32(kKeyBitWidth, &bitWidth) && bitWidth == 32){
...
#else
		mAudioTrack = new AudioTrack(AUDIO_STREAM_MUSIC, mSampleRate, AUDIO_FORMAT_PCM_16_BIT, audioMask,
									 0, AUDIO_OUTPUT_FLAG_NONE, &AudioCallback, this, 0);
#endif
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI end
