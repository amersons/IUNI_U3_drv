...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
#ifndef CONFIG_GN_Q_BSP_HIFI_24BITS
...
#endif
#ifdef WAVEXT_PCM_DATA_DUMP
			FILE *fp;
			if ((fp = fopen("/data/wavext1.cap", "a+")) != NULL) {
				fwrite((uint8_t *)buffer->data(), 1, n, fp);
				fclose(fp);
			}else{
				ALOGE("wavext1.cap OPEN FAILED");
			}
#endif
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI end
        }
