...
#ifndef ANDROID_AUDIO_GIONEE_MIXER_H
#define ANDROID_AUDIO_GIONEE_MIXER_H
...
class AudioGioneeMixer
{
public:
							AudioGioneeMixer(size_t frameCount, uint32_t sampleRate,
									   uint32_t maxNumTracks = MAX_NUM_TRACKS);

	/*virtual*/             ~AudioGioneeMixer();  // non-virtual saves a v-table, restore if sub-classed
	...
	static const uint16_t UNITY_GAIN = 0x1;
...
private:
	...
	/* void process__OneTrack16BitsStereoNoResampling(state_t* state, */
	/*																 int64_t pts); */
...
#endif // ANDROID_AUDIO_GIONEE_MIXER_H
