...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
                ...
                int32_t     *mixBuffer() const { return mMixBuffer; };
#else
...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
    ...
    // for dynamic change hal buffer size
    int32_t                         mLowLatencyHalBufferSize;
    size_t                          mLowLatencyFrameCount;  
    uint32_t                        mScreenStateForChangeHalBuffer;
#else
...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
#ifdef GIONEE_HIFI_24BITS_AUDIOFLINGER
    virtual int             getTrackName_l(audio_channel_mask_t channelMask, audio_format_t format, int sessionId) = 0;
#else
...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
#ifdef GIONEE_HIFI_24BITS_AUDIOFLINGER
    virtual     int         getTrackName_l(audio_channel_mask_t channelMask, audio_format_t format, int sessionId);
#else
...
//GIONEE guogy 2014-10-31 CR01406672 modify for 24bits HIFI begin
#ifdef GIONEE_HIFI_24BITS_AUDIOFLINGER
                AudioGioneeMixer* mAudioMixer;    // normal mixer
#else
