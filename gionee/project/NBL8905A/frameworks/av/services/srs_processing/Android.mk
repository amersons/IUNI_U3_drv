...
ifneq ($(AND_PLAT_KK),true)
LOCAL_MODULE := libsrsprocessing_libs
LOCAL_MODULE_TAGS := eng
endif

ifeq ($(SRS_TECH_WOWHDX),true)
LOCAL_PREBUILT_LIBS += srs_libs/srs_wowhdx_$(SRSLIB_PLAT)_NDK.a
endif
...
LOCAL_PREBUILT_LIBS += srs_libs/srs_widesrd_$(SRSLIB_PLAT)_NDK.a
endif
...
LOCAL_PREBUILT_LIBS += srs_libs/srs_tbhd_$(SRSLIB_PLAT)_NDK.a
endif
...
ifeq ($(SRS_TECHLIB_PEQ),true)
LOCAL_PREBUILT_LIBS += srs_libs/srs_peq_$(SRSLIB_PLAT)_NDK.a
endif

ifeq ($(SRS_TECH_GEQ),true)
LOCAL_PREBUILT_LIBS += srs_libs/srs_geq_$(SRSLIB_PLAT)_NDK.a
endif

LOCAL_PREBUILT_LIBS += srs_libs/srs_common_$(SRSLIB_PLAT)_NDK.a

# License libraries needed by both SRS license and dsec
LOCAL_PREBUILT_LIBS += license/libsrs_spool_$(SRS_PROTECT_TYPE)_$(SRSLIB_PLAT)_NDK.a
LOCAL_PREBUILT_LIBS += license/libdts-security-dsec_$(SRSLIB_PLAT)_NDK.a
...
ifeq ($(SRS_TECHLIB_PEQ),true)
LOCAL_STATIC_LIBRARIES += srs_peq_$(SRSLIB_PLAT)_NDK
endif
