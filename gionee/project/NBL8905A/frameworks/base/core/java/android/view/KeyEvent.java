...
//add liujiang hall-key start
	public static final int KEYCODE_HALL_O     = 250;
    public static final int KEYCODE_HALL_C     = 251;
//add liujiang hall-key end
//Gionee luliya 2014-5-25 add for ctp begin 
	public static final int AKEYCODE_GESTURE_U_UP             = 252;
    public static final int AKEYCODE_GESTURE_U_DOWN           = 253;
    public static final int AKEYCODE_GESTURE_U_LEFT           = 254;
    public static final int AKEYCODE_GESTURE_U_RIGHT          = 255;
    public static final int AKEYCODE_DOUBLE_WAKE              = 256;
	public static final int AKEYCODE_CROSS_RIGHT              = 257;
	public static final int AKEYCODE_CROSS_LEFT               = 258;
	public static final int AKEYCODE_CHARACTER_O               = 259;
//Gionee luliya 2014-5-25 add for ctp end
