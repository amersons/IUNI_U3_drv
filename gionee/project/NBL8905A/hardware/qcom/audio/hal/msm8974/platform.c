...
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873/CR01334214 begin
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
    [SND_DEVICE_OUT_MMI_TEST_HANDSET] = "mmi-test-handset",
    [SND_DEVICE_OUT_MMI_TEST_HANDSET_AND_HEADPHONE] = "mmi-test-handset-and-headphone",
#endif
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873/CR01334214 end
...
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
    [SND_DEVICE_IN_MMI_TEST_DMIC1] = "mmi-test-dmic1",
    [SND_DEVICE_IN_MMI_TEST_DMIC2] = "mmi-test-dmic2",
    [SND_DEVICE_IN_MMI_TEST_DMIC3] = "mmi-test-dmic3",
#endif
...
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873/CR01334214 begin
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
    [SND_DEVICE_OUT_MMI_TEST_HANDSET] = 7,
    [SND_DEVICE_OUT_MMI_TEST_HANDSET_AND_HEADPHONE] = 7,
#endif
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873/CR01334214 end
...
//Gionee Driver tangwei 20141029 modify for CR01403940 start
    [SND_DEVICE_IN_VOICE_SPEAKER_DMIC] = 11,
//Gionee Driver tangwei 20141029 modify for CR01403940 end
...
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873 begin
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
    [SND_DEVICE_IN_MMI_TEST_DMIC1] = 4,
    [SND_DEVICE_IN_MMI_TEST_DMIC2] = 11,
    [SND_DEVICE_IN_MMI_TEST_DMIC3] = 11,
#endif
//Gionee huangzhuolin 20140506 add for mic mmitest by CR01236873 end
};
...
//Gionee huangzhuolin 20140725 add for AutoMMI test by CR01334214/CR01334214 begin
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
	if (devices & AUDIO_DEVICE_OUT_WIRED_HEADSET || devices & AUDIO_DEVICE_OUT_WIRED_HEADPHONE){
		if (adev->mmi_test_mic != 0) {
			ALOGE("%s:----handset and headphone------ adev->mmi_test_mic == %d",__func__, adev->mmi_test_mic);
            snd_device = SND_DEVICE_OUT_MMI_TEST_HANDSET_AND_HEADPHONE;
			return snd_device;
        }
	} else if (devices & AUDIO_DEVICE_OUT_EARPIECE) {
    	if (adev->mmi_test_mic == 1) {
			ALOGE("%s:----handset------ adev->mmi_test_mic == 1",__func__);
            snd_device = SND_DEVICE_OUT_MMI_TEST_HANDSET;
			return snd_device;
    	}
	}
#endif
//Gionee huangzhuolin 20140725 add for AutoMMI test by CR01334214/CR01334214 end
...
//Gionee huangzhuolin 20140725 add for mic mmitest by CR01236873/CR01334214 begin
#ifdef CONFIG_GN_Q_BSP_AUDIO_MMI_TEST_SUPPORT
	if(adev->mmi_test_mic != 0) {
        ALOGD("%s : adev->mmi_test_mic  == %d",__func__, adev->mmi_test_mic);
		if(adev->mmi_test_mic == 1) {
        	snd_device = SND_DEVICE_IN_MMI_TEST_DMIC1;
			return snd_device;
		} else if(adev->mmi_test_mic == 2) {
        	snd_device = SND_DEVICE_IN_MMI_TEST_DMIC2;
			return snd_device;
		} else if(adev->mmi_test_mic == 3) {
        	snd_device = SND_DEVICE_IN_MMI_TEST_DMIC3;
			return snd_device;
		}
	}
#endif
//Gionee huangzhuolin 20140725 add for mic mmitest by CR01236873/CR01334214 end
