...
static struct clk_lookup msm_clocks_8974pro_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "22.qcom,camera"),//pangfei add for ov13860
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "13.qcom,eeprom"),//pangfei add for ov13860 eeprom
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "90.qcom,camera"),
//add by lizhi for camera clock control begin
#ifdef CONFIG_GN_CAMERA_SUPPORT
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6a.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "6a.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6b.qcom,eeprom"),
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "6b.qcom,eeprom"),
#endif
//add by lizhi for camera clock control end

	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6e.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "20.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "22.qcom,camera"),//pangfei add for ov13860
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "13.qcom,eeprom"),//pangfei add for ov13860 eeprom
...
static struct clk_lookup msm_clocks_8974_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", mmss_gp0_clk_src.c, "22.qcom,camera"),//pangfei add for ov13860
...
//add by lizhi for camera clock control end
	...
	CLK_LOOKUP("cam_clk", camss_gp0_clk.c, "22.qcom,camera"),//pangfei add for ov13860
