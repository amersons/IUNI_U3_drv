...
//Gionee taochao 2014-7-9, add for CR01312731 begin
#if 0
	else if ((cpu_is_msm8x60() || chk_apps_master()) && (*buf == 0x3A)) {
#else
	else if ((cpu_is_msm8x60() || chk_apps_master()) && (*buf == 0x3A) && (*(buf+1) == 0xA1) && (*(buf+2) == 0x6E) && (*(buf+3) == 0x7E)) {
#endif
//Gionee taochao 2014-7-9, add for CR01312731 end
		/* send response back */
