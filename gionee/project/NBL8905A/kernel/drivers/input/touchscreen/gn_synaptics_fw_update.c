...
// Gionee liudj add for distinguish lcd module
u8 g_panel_modle = 0;
		...
		if (!fwu->firmware_name) {
         ...
         if (retval < 0) {
             printk("%s : read product id failed...\n",__func__);
                ...
                printk("%s product_id = %s \n",__func__, product_id);      
                if (!strncmp(product_id, "OB", 2)) {
                     printk("%s firmware: This is O-film Black Module.\n",__func__);
                     snprintf(fwu->firmware_name, NAME_BUFFER_SIZE, "%s",
                fwu->rmi4_data->board->fw_image_name1);
                 } else if (!strncmp(product_id, "OW", 2)) {
                     printk("%s firmware: This is O-film White Module.\n",__func__);
                     snprintf(fwu->firmware_name, NAME_BUFFER_SIZE, "%s",
                fwu->rmi4_data->board->fw_image_name2);
                 } else if (!strncmp(product_id, "TB", 2)) {
                     printk("%s firmware: This is Truly Black Module.\n",__func__);
                     snprintf(fwu->firmware_name, NAME_BUFFER_SIZE, "%s",
                fwu->rmi4_data->board->fw_image_name3);
                 } else if (!strncmp(product_id, "TW", 2)) {
                     printk("%s firmware: This is Truly White  Module.\n",__func__);
                     snprintf(fwu->firmware_name, NAME_BUFFER_SIZE, "%s",
                fwu->rmi4_data->board->fw_image_name4);
                 }  else {
...
//gionee liudj add for distinguish lcd module 2014.01.16 begin
...
//gionee liudj add for distinguish lcd module 2014.01.16 end
