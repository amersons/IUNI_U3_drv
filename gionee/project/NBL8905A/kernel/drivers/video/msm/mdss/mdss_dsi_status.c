...
//gionee caomingliang add 20140816 begin
	pr_err("@@@--1--%s: ret is %d panel power on is %d\n", __func__, ret, pdsi_status->mfd->panel_power_on);
//gionee caomingliang add 20140816 end
