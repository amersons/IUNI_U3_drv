...
APK_DEFAULT_SMS_SUPPORT = no
APK_DEFAULT_CONTACTS_SUPPORT = no
APK_DEFAULT_CALCULATOR_SUPPORT= no
APK_DEFAULT_CAMERA_SUPPORT = no
APK_DEFAULT_DESKCLOCK_SUPPORT = no
APK_DEFAULT_DIALER_SUPPORT = no
APK_DEFAULT_EMAIL_SUPPORT = no
APK_DEFAULT_EXCHANGE_SUPPORT = no
APK_DEFAULT_GALLERY_SUPPORT = no
APK_DEFAULT_GALLERY2_SUPPORT = no
APK_DEFAULT_HTMLVIEWER_SUPPORT = no
APK_DEFAULT_INCALLUI_SUPPORT = no
APK_DEFAULT_LAUNCHER2_SUPPORT = no
APK_DEFAULT_LAUNCHER3_SUPPORT = no
APK_DEFAULT_LEGACYCAMERA_SUPPORT = no
APK_DEFAULT_MUSIC_SUPPORT = no
APK_DEFAULT_PACKAGEINSTALLER_SUPPORT = no
APK_DEFAULT_PHONE_SUPPORT = no
APK_DEFAULT_PROTIPS_SUPPORT = no
APK_DEFAULT_PROVISION_SUPPORT = no
APK_DEFAULT_QUICKSEARCHBOX_SUPPORT = no
APK_DEFAULT_SETTINGS_SUPPORT = no
APK_DEFAULT_SMARTCARDSERVICE_SUPPORT = no
APK_DEFAULT_SOUNDRECORDER_SUPPORT = no
APK_DEFAULT_SPAREPARTS_SUPPORT = no
APK_DEFAULT_SPEECHRECORDER_SUPPORT = no
APK_DEFAULT_VIDEOEDITOR_SUPPORT = no
APK_DEFAULT_VOICEDIALER_SUPPORT = no
APK_DEFAULT_BASICSMSRECEIVER_SUPPORT = no
APK_DEFAULT_CELLBROADCASTRECEIVER_SUPPORT = no
APK_DEFAULT_NFC_SUPPORT = no
APK_DEFAULT_TAG_SUPPORT = no
APK_DEFAULT_CALCULATOR_SUPPORT = no
APK_DEFAULT_ONETIMEINITIALIZER_SUPPORT = no
APK_DEFAULT_CALENDAR_SUPPORT = no
APK_DEFAULT_CONTACTSCOMMON_SUPPORT = no
APK_DEFAULT_BTTESTAPP_SUPPORT = no
APK_DEFAULT_DIGITALPENSERVICE_SUPPORT = no
APK_DEFAULT_DIGITALPENSETTINGS_SUPPORT = no
APK_DEFAULT_HIDDTESTAPP_SUPPORT = no
APK_DEFAULT_DOCUMENTSUI_SUPPORT = no
APK_DEFAULT_XTRA_T_APP_SUPPORT = no
APK_DEFAULT_CALENDARPROVIDER_SUPPORT = no
APK_DEFAULT_CONTACTSPROVIDER_SUPPORT = no
APK_DEFAULT_TELEPHONYPROVIDER_SUPPORT = no
APK_DEFAULT_DOWNLOADPROVIDER_SUPPORT = no
APK_DEFAULT_WAPPUSHMANAGER_SUPPORT = no
APK_DEFAULT_SYSTEMUI_SUPPORT = no
APK_DEFAULT_SHELL_SUPPORT = no
APK_DEFAULT_KEYGUARD_SUPPORT = no
APK_DEFAULT_QSENSORTEST_SUPPORT = no
APK_DEFAULT_QVTESTER_SUPPORT = no
APK_DEFAULT_QUALCOMMSETTINGS_SUPPORT = no
APK_DEFAULT_QSSEPKCS11OTPGEN_SUPPORT = no
APK_DEFAULT_PENPAIRINGAPP_SUPPORT = no
APK_DEFAULT_ULTRASOUNDSETTINGS_SUPPORT = no
APK_DEFAULT_MULTIPLEPDPTEST_SUPPORT = no
APK_DEFAULT_QLOGCAT_SUPPORT = no
APK_DEFAULT_PLAYREADYDRMTESTING_SUPPORT = no
APK_DEFAULT_CNESETTINGS_SUPPORT = no
APK_DEFAULT_EXTENDEDOFFSCREEN_SUPPORT = no
APK_DEFAULT_EMBMSTESTAPP_SUPPORT = no
APK_DEFAULT_MSAPU_SUPPORT = no
APK_DEFAULT_DLT_SUPPORT = no
APK_DEFAULT_QSSEP11ENCRYPTORDECRYPTOR_SUPPORT = no
APK_DEFAULT_WFDCLIENT_SUPPORT = no
APK_DEFAULT_TREPN_SUPPORT = no
APK_DEFAULT_HOME_SUPPORT = no
APK_DEFAULT_TELESERVICE_SUPPORT = no
APK_DEFAULT_QTIBACKUPAGENT_SUPPORT = no
APK_DEFAULT_LATINIME_SUPPORT = no
APK_DEFAULT_OPENWNN_SUPPORT = no
APK_DEFAULT_PINYINIME_SUPPORT = no
APK_DEFAULT_CAMERA2_SUPPORT = no
APK_DEFAULT_ORIGINAL_AUDIO_SUPPORT = no
APK_DEFAULT__SUPPORT = no
#
# Copyright (C) 2007 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
...
#Gionee huangzhuolin 2014-06-30 add for SRS CR01311718 begin
GN_DTS_SUPPORT = y
#Gionee huangzhuolin 2014-06-30 add for SRS CR01311718 end
...
#Gionee liujiang 2013-09-22 add for akm8963 pdc begin
GN_Q_BSP_AKM8963_PDC_SUPPORT = yes
#Gionee liujiang 2013-09-22 add for akm8963 pdc end
...
GN_Q_BSP_BMS_OPTIMIZE_SOC_SUPPORT = n
...
GN_Q_BSP_LCD_TE_ANALOG_SUPPORT = y
...
GN_Q_BSP_BMS_OPTIMIZE_PHONE_RESTART_SOC_SUPPORT = n
...
GN_ARCSOFT_FACE_BEAUTY_SUPPORT = yes
GN_CAMERA_FEATURE_LIVE_EFFECT_SUPPORT = yes
GN_ARCSOFT_LIVE_EFFECT_SUPPORT = yes
GN_CAMERA_FEATURE_NIGHT_SHOT_SUPPORT = yes
GN_ARCSOFT_NIGHT_SHOT_SUPPORT = yes
GN_SCALADO_FEATURE_SUPPORT = yes
GN_SCALADO_MIRROR_SUPPORT = yes
#Gionee <zhuangxiaojian> <2014-05-20> modify for CR01261494 end 
############ DRIVER MACRO DEFINE  END  ###################

############# CUST BEGIN ##################################
GN_EXTERNAL_VERNUMBER = SV1.0 
GN_EXTERNAL_MODEL = U3
...
GN_DEVICE_MODEL = IUNI U810
GN_RO_GN_GNVERNUMBERREL = 01
GN_ROM_VERNUMBER = IUNI ROM4.4
GIONEEPROJECTID=NBL8910A
...
GN_CTA_SEC_SUPPORT=no
GN_CTA_QQ_STEWARD_SUPPORT=no
# Gionee <daizm> <2013-10-11> add for CTA Permission end
#IUNI <wangyongliang>add DTS file
###GN_DTS_SUPPORT=yes not need 
#IUNI <wangyongliang>add DTS file
